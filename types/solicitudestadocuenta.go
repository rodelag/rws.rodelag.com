...
var SolicitudEstadoCuentaComentarioType = graphql.NewObject(graphql.ObjectConfig{
	Name:        "SolicitudEstadoCuentaComentario",
	Description: "Comentario de registro para los estados de cuenta",
...
var SolicitudEstadoCuentaType = graphql.NewObject(graphql.ObjectConfig{
	...
	Fields: graphql.Fields{
		...
		"comentarios": &graphql.Field{
			Type:        graphql.NewList(SolicitudEstadoCuentaComentarioType),
